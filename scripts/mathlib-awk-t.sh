...
if [ -f $file ]
then 
	awk '($1 != "#align")&&($1 != "#noalign")&&($2 !="Mathlib.Mathport.Rename")&&($2 !="Mathlib.Mathport.Attributes")&&($2 !="Mathlib.Mathport.Notation") {split($2,a,"\.");if (((a[1]=="Std")||(a[1]=="Aesop")||(a[1]=="Qq"))&&($1 == "import")){$2="Mathlib."$2 } ;print $0 }' $file >"target2/"$file
fi
done
